            ...
            <div class="row mt-2">
                  <div class="col-md-12">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control @error('Fullname') is-invalid @enderror" id="inputFullname" name="Full_name" value="{{ $data2->full_name }}">
                          @error('Fullname')
              ...
              <div class="row mt-2">
                <div class="col-md-12">
                    <div class="form-group">
                      <label for="Specialist" class="bmd-label-floating ml-1">Gender</label>
                      <select class="form-select form-control" id="inputSpecialist" name="Specialist">
                        <option>{{ $data2->gender }}</option>
                      </select>
                    </div>
                </div>
              </div>
